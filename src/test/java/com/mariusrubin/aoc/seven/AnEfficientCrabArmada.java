 ...
 * @since 0.1.0
 */
public class AnEfficientCrabArmada {
  ...
  @BeforeEach
  public void init() {
    underTest = new EfficientCrabArmada(INITIAL_POSITIONS);
  }

  @Test
  public void shouldFindTheCheapestPosition() {
    assertThat(underTest.findCheapestPosition().position()).isEqualTo(2);
  }

  @Test
  public void shouldCalculateFuelCostOfCheapestPosition() {
    assertThat(underTest.findCheapestPosition().fuel()).isEqualTo(37);
  }
